...
- (IBAction)printBarcodeITF
{
    ...
    [PrinterFunctions PrintCodeITFWithPortname:portName portSettings:portSettings barcodeData:barcodeBytes barcodeDataSize:(unsigned int)[barcodeData length] barcodeOptions:layout height:height narrowWide:width];
