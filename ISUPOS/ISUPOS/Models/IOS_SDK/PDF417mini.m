...
- (IBAction)showHelp
{
    ...
    helpText = [helpText stringByAppendingString:@"<UnderlineTitle>Set PDF417</UnderlineTitle><br/><br/>\n\
                ...
                * Note: This code must be used before the other QRcode command.  It sets the printer to use pdf417 code<br/><br/>\
                ...
                <rightMov>dL</rightMov> <rightMov_NOI>Represents the lower byte describing the number of bytes in the pdf417 code.  Mathematically: dL = qrcode Length % 256</rightMov_NOI><br/><br/><br/>\
                <rightMov>dH</rightMov> <rightMov_NOI>Represents the higher byte describing the number of bytes in the pdf417 code.  Mathematically: dH = qrcode = Length / 256</rightMov_NOI><br/><br/><br/>\
...
//  unsigned char ratio    = selectedRatio;
    unsigned char ratio    = (unsigned char)(selectedRatio + 2);

    [MiniPrinterFunctions PrintPDF417WithPortname:portName portSettings:portSettings width:width columnNumber:column securityLevel:security ratio:ratio barcodeData:barcodeBytes barcodeDataSize:[barcodeData length]];
