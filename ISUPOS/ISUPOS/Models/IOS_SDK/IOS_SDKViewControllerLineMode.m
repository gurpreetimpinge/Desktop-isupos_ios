...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        arrayFunction = [[NSArray alloc] initWithObjects:@"Get Firmware Information", @"Get Status", @"Sample Receipt", @"JP Sample Receipt", @"Open Cash Drawer 1", @"Open Cash Drawer 2",
                                                         @"1D Barcodes", @"2D Barcodes", @"Cut", @"Text Formatting", @"JP Kanji Text Formatting", @"Bluetooth Pairing + Connect",
...
- (void)viewDidLoad
{
    ...
    [[Mint sharedInstance] leaveBreadcrumb:@"IOS_SDK_LineMode_ViewController"];
