...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        [self.button_Done setTitle:[Language get:@"Done" alter:@"!Done"] forState:UIControlStateNormal];
        [self.buttonClear setTitle:[Language get:@"Clear" alter:@"!Clear"] forState:UIControlStateNormal];
        [self addObservers];
    }
    return self;
}
