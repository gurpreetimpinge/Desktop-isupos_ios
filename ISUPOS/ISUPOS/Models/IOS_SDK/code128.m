...
- (IBAction)printBarcode128
{
    ...
    [PrinterFunctions PrintCode128WithPortname:portName portSettings:portSettings barcodeData:barcodeBytes barcodeDataSize:(unsigned int)[barcodeData length] barcodeOptions:layout height:height min_module_dots:width];
