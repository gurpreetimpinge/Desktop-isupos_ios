...
@interface IOS_SDKViewControllerPortable : UIViewController <UITextFieldDelegate, UITableViewDelegate, UITableViewDataSource, UIActionSheetDelegate, ReturnSelectedCellTextDelegate> {
